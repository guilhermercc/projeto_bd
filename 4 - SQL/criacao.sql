...
CREATE TABLE USUARIO(
    ...
    TIPO_USUARIO VARCHAR(10) NOT NULL CHECK (TIPO_USUARIO IN ('Espectador', 'Streamer'))
);
...
CREATE TABLE ESPECTADOR(
    ...
    CONSTRAINT CK_ESPECTADOR CHECK (TIPO_USUARIO = 'Espectador')
);
...
CREATE TABLE STREAMER(
    ...
    CONSTRAINT CK_ESPECTADOR CHECK (TIPO_USUARIO = 'Streamer')
);
