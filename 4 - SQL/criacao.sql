...
CREATE TABLE CATEGORIA_INTERESSE(
    ...
    CONSTRAINT FK_CATEGORIA_INTERESSE FOREIGN KEY (CPF) REFERENCES ESPECTADOR(CPF) ON DELETE CASCADE
);
...
CREATE TABLE CATEGORIA(
    ...
    CONSTRAINT FK_CATEGORIA FOREIGN KEY (CPF, NOME_CANAL) REFERENCES CANAL(CPF, NOME_CANAL) ON DELETE CASCADE
);
...
CREATE TABLE VISUALIZA(
    ...
    CONSTRAINT FK_VISUALIZA_CPF FOREIGN KEY (CPF) REFERENCES ESPECTADOR(CPF) ON DELETE CASCADE,
...
CREATE TABLE COMENTARIOS(
    ...
    CONSTRAINT FK_COMENTARIOS FOREIGN KEY (CPF, ID_CONTEUDO, DATA_VISUALIZACAO) REFERENCES VISUALIZA(CPF, ID, DATA_VISUALIZACAO) ON DELETE CASCADE
);
