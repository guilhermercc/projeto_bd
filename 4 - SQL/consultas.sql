...
-- Identifique o nome dos espectadores que possuem alguma categoria de interesse em comum com alguma categoria de canais de streamers

SELECT E.NOME, COUNT(*)
FROM ESPECTADOR E INNER JOIN CATEGORIA_INTERESSE CI ON E.CPF=CI.CPF
WHERE CI.CATEGORIA_INTERESSE IN (SELECT CA.CATEGORIA FROM CATEGORIA CA)
GROUP BY E.NOME